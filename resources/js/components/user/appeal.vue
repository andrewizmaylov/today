<template>
	<div>
		<div class="meal-txt text-4xl" @click="showUserMenu=true">Привет, {{appeal()}}</div>
		<div class="flex flex-col mt-16 absolute z-30 inset-0 bg-gray-800 h-full w-full" v-show="showUserMenu">
